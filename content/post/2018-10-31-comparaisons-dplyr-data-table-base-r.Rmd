---
title: Comparaisons dplyr - data.table - base R
...
tags:
  ...
  - microbenchmark
  - tidyverse
slug: comparaisons-dplyr-data-table-base-r
header:
  caption: ''
  image: ''
output:
...
Il n'y a plus qu'à tester! On propose des tests sur 10 000, 100 000 et 1 million de lignes avec à chaque fois peu (1/1000e du nombre de lignes) ou beaucoup (la moitié du nombre de lignes) de groupes.

__10 000 lignes pour 10 groupes__
```{r echo=FALSE, message=FALSE, warning=FALSE}
test_group_by(10000, 10)
```

__10 000 lignes pour 5 000 groupes__
```{r echo=FALSE, message=FALSE, warning=FALSE}
test_group_by(10000, 5000)
```

__100 000 lignes pour 100 groupes__
```{r echo=FALSE, message=FALSE, warning=FALSE}
test_group_by(100000, 100)
```

__100 000 lignes pour 50 000 groupes__
```{r echo=FALSE, message=FALSE, warning=FALSE}
test_group_by(100000, 50000)
```

__1 million de lignes pour 1 000 groupes__
```{r echo=FALSE, message=FALSE, warning=FALSE}
test_group_by(1000000, 1000)
```

__1 million de lignes pour 500 000 groupes__
```{r echo=FALSE, message=FALSE, warning=FALSE}
