...
# Edit 2020  
_Pour la gestion de packages, `renv` vise désormais à remplacer `packrat`. Pour l'utilisateur, le fonctionnement est très semblable mais il est plus performant, et corrige notamment certains défauts évoqués dans cet article. Vous pouvez découvrir ce package sur le [site de RStudio](https://rstudio.github.io/renv/articles/renv.html)._  
