...
data.frame(x = tap, y = names(tap))
```
Notons que dans ce cas, on ajoute une étape pour transformer l'output doit être un dataframe. On aurait aussi pu utiliser la fonction `aggregate` qui permet cela.
